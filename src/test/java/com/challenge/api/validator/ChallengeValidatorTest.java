...
class ChallengeValidatorTest {
    ...
    @DisplayName("존재하는 챌린지 ID로 조회하는 경우 예외가 발생하지 않는다.")
    @Test
    void validateChallengeExists_when_ExistsChallengeId() {
        // given
        ...
        Challenge challenge = Challenge.create(member, category, request, now);
        challengeRepository.save(challenge);

        // when // then
        assertThatCode(() -> challengeValidator.validateChallengeExists(challenge.getId()))
